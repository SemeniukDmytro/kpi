...
public partial class JavaScriptParserBaseListener : IJavaScriptParserListener {
	...
	/// <summary>
	/// Enter a parse tree produced by the <c>NamedFunction</c>
	/// labeled alternative in <see cref="JavaScriptParser.anonymousFunction"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterNamedFunction([NotNull] JavaScriptParser.NamedFunctionContext context) { }
	/// <summary>
	/// Exit a parse tree produced by the <c>NamedFunction</c>
	/// labeled alternative in <see cref="JavaScriptParser.anonymousFunction"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitNamedFunction([NotNull] JavaScriptParser.NamedFunctionContext context) { }
	/// <summary>
