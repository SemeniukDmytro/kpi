...
public interface IJavaScriptParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterNamedFunction([NotNull] JavaScriptParser.NamedFunctionContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>NamedFunction</c>
	/// labeled alternative in <see cref="JavaScriptParser.anonymousFunction"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitNamedFunction([NotNull] JavaScriptParser.NamedFunctionContext context);
	/// <summary>
